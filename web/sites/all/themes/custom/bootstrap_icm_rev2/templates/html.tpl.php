...
<head>
  ...
  <link href='https://fonts.googleapis.com/css?family=Montserrat:100,200,300,800
' rel='stylesheet'>
  <?php print $styles; ?>
...
<div id="cu-identity">
	<div class="main-container container graybar">
		<div id="cu-logo">
			<a href="http://www.cornell.edu/"></a>
		</div>
		<div id="search-form">
			<a href="http://www.cornell.edu/search/">Search Cornell</a></div>
		</div>
	</div>
</div>
