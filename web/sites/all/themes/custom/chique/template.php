...
$pin_slideshow_thumbnails=theme_get_setting('slideshow_thumbnails');

if ($pin_slideshow_thumbnails) {
	drupal_add_js('jQuery(document).ready(function($) { 
	
	if(document.getElementById("slideshow-navigation-container")) {
    document.getElementById("slideshow-navigation-container").style.display="block";
	}
